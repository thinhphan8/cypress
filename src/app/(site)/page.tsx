            ...
            <section
                ...
                <div
                    ...
                    <TitleSection
                        ...
                        subheading='Capture your ideas, thoughts, and meeting notes in a stuctured and organized place'
                        pill='Features'/>
                    <div
                        className="
                    mt-10
            ...
            <section className="relative">
                ...
                <div
                    ...
                    <TitleSection
                        ...
                        subheading="Join thousands of satisfied users who rely on our platform for their personal
                        and professional productivity needs."
                        pill="Testimonials"
                    />
                        ...
                        <CustomCard
                            ...
                            cardContent={
                                <CardContent className="p-0">
                                    ...
                                    <p className="dark:text-washed-purple-800 whitespace-nowrap">
                                        {card.description}
                                    </p>
